...
* add agent-specific model constraints and refactor generation ([3f9ccf7](https://github.com/harvis-io/vibesdk/commit/3f9ccf7b3b1b137d6255493da14f8463ce8a66f3))
* add ai-based project type detection and workflow support ([f753f8b](https://github.com/harvis-io/vibesdk/commit/f753f8bc1dc587de106dc1b413c11fc796cbd7cb))
* add app visibility check for preview deployment ([3c4f203](https://github.com/harvis-io/vibesdk/commit/3c4f2030d730e95fe0bd8deb17b1265cd5f20ecf))
* add blueprint parsing utilities and enhanced session state tracking to SDK ([96168d5](https://github.com/harvis-io/vibesdk/commit/96168d54ebf8352af9bfdf9113f04a3df5aaf90b))
* add bonk ai code reviews ([189dc48](https://github.com/harvis-io/vibesdk/commit/189dc4837166b3a6887a2d400eb76f0641cc36a0))
* add bonk ai code reviews ([e16961b](https://github.com/harvis-io/vibesdk/commit/e16961b8ab367634471d75da0c5630c8abaf9046))
* add clarifying questions flow for Think agent ([a52cf10](https://github.com/harvis-io/vibesdk/commit/a52cf10740c3c9c7a3914dcaedee97018b48ddc2))
* add common pitfalls and dependency documentation to phase implementation prompt ([0184e5f](https://github.com/harvis-io/vibesdk/commit/0184e5fadf4f8c2a0f31d6e11853b7cd2115e5b1))
* add completion detection and dependency-aware tool execution ([0f85a7d](https://github.com/harvis-io/vibesdk/commit/0f85a7d00934cbc3ec4beb706689cbda93478fb8))
* add completion detection and loop prevention to agentic builder and debugger ([e926e18](https://github.com/harvis-io/vibesdk/commit/e926e18b1bbce27f53df7758d46929426e056e07))
* add concurrency control and cleanup for Claude review workflow ([b5a76da](https://github.com/harvis-io/vibesdk/commit/b5a76dae70febd9c624ab75f4f0e117c044c5c4e))
* add dedicated AI changelog workflow and improve release-please gating ([4e97d5a](https://github.com/harvis-io/vibesdk/commit/4e97d5a8e1e85be02d04bf3c62a00d2ab8ff5f62))
* add ENABLE_EMAIL_AUTH flag and surface oauth conflict error ([fd052ac](https://github.com/harvis-io/vibesdk/commit/fd052ac92ef7dfac87316d62d834a62a5e3e4798))
* add feature modules and capabilities discovery ([0534a95](https://github.com/harvis-io/vibesdk/commit/0534a955f40682cd0163ed315a4963cfde0cf1b4))
* add HTTP retry logic with exponential backoff to SDK client ([b02025e](https://github.com/harvis-io/vibesdk/commit/b02025e050adc6c6c7fa324211743b63efe6df49))
* add integration test controls and exclude from pre-commit hooks ([e68369b](https://github.com/harvis-io/vibesdk/commit/e68369b9e61b4eb7ad56b30d4c39c2b55d437fd2))
* add Login with Cloudflare and per-user AI Gateway toggle (VIBE-22) ([0ebf48d](https://github.com/harvis-io/vibesdk/commit/0ebf48da439502090cc44a307fa7ef08d3de965d))
* add missing environment variables to .prod.vars template generation ([7127cad](https://github.com/harvis-io/vibesdk/commit/7127cadd0c7a8b2b456c7e7bd79371af98f8d3b8))
* add missing environment variables to deployment workflow and script ([965381c](https://github.com/harvis-io/vibesdk/commit/965381ca7e47bd138656cb50d47ecd32a388ff6f))
* add new model definitions ([e73a089](https://github.com/harvis-io/vibesdk/commit/e73a08928021823068d5dc2ece0a97d303b30504))
* add phase timeline change subscription and event handling ([a1c7404](https://github.com/harvis-io/vibesdk/commit/a1c740411d7b183d26b334d4c5a2a80ab4905728))
* add phase timeline change subscription and event handling ([f8b14cd](https://github.com/harvis-io/vibesdk/commit/f8b14cde831e284d478633154189e5032dce3506))
* add pre-deploy safety gate with automated code fixing ([611eb8e](https://github.com/harvis-io/vibesdk/commit/611eb8e5bb0cc3c9c3ea56efb7578a3d5117d177))
* add presentation and documentation preview modes ([#234](https://github.com/harvis-io/vibesdk/issues/234)) ([e9a31da](https://github.com/harvis-io/vibesdk/commit/e9a31da370bcf82769ccb85b2286437e63dfc695))
* add project mode selector with agentic behavior support ([b34c707](https://github.com/harvis-io/vibesdk/commit/b34c7079153ee0455a2d2b650a4256365a11e9d7))
* add query length validation with 20k character limit ([8927bf0](https://github.com/harvis-io/vibesdk/commit/8927bf01b48ff4357a1d2e46cb5cb518ef9cbde4))
* add query length validation with 20k character limit ([715d21f](https://github.com/harvis-io/vibesdk/commit/715d21fca5a2ac04972d9b7eea600471b81663b9))
* add read-only Artifacts HTTP router ([cfcfb70](https://github.com/harvis-io/vibesdk/commit/cfcfb7030b2dfc9c3704796f2a3710fa700135f7))
* add read-only Artifacts repo viewer for think apps ([4b75d88](https://github.com/harvis-io/vibesdk/commit/4b75d883eab2527242f4420a3585ad99f366176f))
* add release-live deployment workflow and vitest bun:test alias ([a71e382](https://github.com/harvis-io/vibesdk/commit/a71e3826bf011c90bdbd89d26a0ab3a8bd0edc7c))
* add retry logic and blank screenshot detection for browser rendering ([c30a422](https://github.com/harvis-io/vibesdk/commit/c30a422fa606bac5480ba7bca8cc31178e08db6d))
* add SDK documentation and usage example to main README ([3b11517](https://github.com/harvis-io/vibesdk/commit/3b11517310cd4fc5594cdab4caf1316ea7b4e9ce))
* add the client and React surfaces ([0e1f72f](https://github.com/harvis-io/vibesdk/commit/0e1f72fa77ad6da57871ba70c132ef1252a4ec1d))
* agentic streaming presentations finally working ([00fc51c](https://github.com/harvis-io/vibesdk/commit/00fc51cfb6e729409f530f1b14b1b601b18fdaab))
* bring app actions to chat page as well from app page ([f33e163](https://github.com/harvis-io/vibesdk/commit/f33e1636a5cc1f970a9a6d425942a1cbd3281916))
* bug fixes + save manifest and slides proactively upon generation ([ff47fc8](https://github.com/harvis-io/vibesdk/commit/ff47fc8b2f4df9921eb0f278bb7942d15849746a))
* change the official preview domain to cloudflarepreviews.net ([516f92c](https://github.com/harvis-io/vibesdk/commit/516f92cbc5ac94024ae5a933cd3aa93b29b666fd))
* **chat:** ordered reasoning + tool trace across all agent behaviors ([942b581](https://github.com/harvis-io/vibesdk/commit/942b581693e3c880c78526f56f72e820d1196bc4))
* **chat:** revamp tool calls ui ([2201ebe](https://github.com/harvis-io/vibesdk/commit/2201ebe639f268c890aa04d59bc6439b4517326b))
* **chat:** revamp tool calls ui ([21c55d7](https://github.com/harvis-io/vibesdk/commit/21c55d7e9c5e1fbf731cc69a1974b059664cd5e5))
* client sdk + tests + docs ([46d7769](https://github.com/harvis-io/vibesdk/commit/46d7769bc12253a4240c5b447772f0391d8f28c3))
* cloudflare oauth connect with usage limits and BYOK inference ([6fc180c](https://github.com/harvis-io/vibesdk/commit/6fc180cd1ee68f19f64aa99410468874d09132cd))
* Cost optimizations via model configs and prompt improvements ([#247](https://github.com/harvis-io/vibesdk/issues/247)) ([2b3a901](https://github.com/harvis-io/vibesdk/commit/2b3a90149d336a1dc5aab6a7e4f999461cf147d3))
* **deploy:** backend-error-driven CF connect popup ([8422857](https://github.com/harvis-io/vibesdk/commit/842285751b5adc16c343cd04c95f52532d5c1135))
* **deploy:** backend-error-driven CF connect popup and ENABLE_USER_ACCOUNT_DEPLOY platform deploys ([dda43bd](https://github.com/harvis-io/vibesdk/commit/dda43bde49fddbb7c24ebc0653a0a2bbfb6a5110))
* enable Agent SDK for all Claude Code Action workflows ([4aa6f5f](https://github.com/harvis-io/vibesdk/commit/4aa6f5f12ab2050930a759d44b1260d6af2103b8))
* enforce template write-protection in simple code generator ([4f0dccf](https://github.com/harvis-io/vibesdk/commit/4f0dccf60661a6ae7ca09fd696270a0152316ea1))
* enhance CI/CD workflows with security and automation improvements ([d86377e](https://github.com/harvis-io/vibesdk/commit/d86377eebfe5d2086f9b9700ea241bec17ae5129))
* enhance Claude review workflow with comment-based triggers and sticky comments ([9716c42](https://github.com/harvis-io/vibesdk/commit/9716c42988338e3026627483680777d9e91abbfb))
* enhance Claude review workflow with improved PR description handling and streamlined review process ([6f6dc84](https://github.com/harvis-io/vibesdk/commit/6f6dc84c11e724f320e3ac2b6d6d8dc224361381))
* enhance rate limit result with exceeded limit details and limit values ([aceac60](https://github.com/harvis-io/vibesdk/commit/aceac6076d51c0d744582ebe7f9f6ce3b08b73ad))
* enhance rate limit result with exceeded limit details and limit values ([721b9e8](https://github.com/harvis-io/vibesdk/commit/721b9e8e2e770530465cc37b057760a6c8b9af47))
* enhance type exports and improve utility functions for better type safety ([47eba5f](https://github.com/harvis-io/vibesdk/commit/47eba5f32ae48efceb07ac9484500cb6e4d3663e))
* **example:** add a Cloudflare Workers demo with five themes ([a9c4c9e](https://github.com/harvis-io/vibesdk/commit/a9c4c9e42d123f2fb3672abd1fac103a3e95d24c))
* **example:** demonstrate renderStatus across the themed designs ([5aa205d](https://github.com/harvis-io/vibesdk/commit/5aa205d0b4909732f37a0321f6cd5c8c481a3b60))
* **example:** route artifacts through Hono at /api/artifacts ([88b73cb](https://github.com/harvis-io/vibesdk/commit/88b73cbadfef85c1a536176913120af3a038746f))
* expand drizzle types script on sdk bundle ([96b709e](https://github.com/harvis-io/vibesdk/commit/96b709e96bb724458bc6bc680bf94f72466c5cb0))
* expand drizzle types script on sdk bundle ([33eb39f](https://github.com/harvis-io/vibesdk/commit/33eb39f2d73a3e89b3f83af79566916935c5b9d2))
* faster blueprint for minimal templates ([1321e43](https://github.com/harvis-io/vibesdk/commit/1321e43cdfecfef9bf47a09006c4408ffab1d8dd))
* finish most refactor and get it to build ([d2a7e02](https://github.com/harvis-io/vibesdk/commit/d2a7e02105d779b9f6278ea564caa65406225945))
* gemini 3 flash ([6452622](https://github.com/harvis-io/vibesdk/commit/64526224e96e8284e345bdcc61cdf28d0c49658a))
* general agent ([45eb5c0](https://github.com/harvis-io/vibesdk/commit/45eb5c087d3b42651027516edd8c4be34958fc13))
* implement phase timeline management and state tracking in SDK ([dbcf51f](https://github.com/harvis-io/vibesdk/commit/dbcf51fd16c75886104cb9c4fd2a93b6ba0923b7))
* implement signed URL security for screenshot access ([6da9166](https://github.com/harvis-io/vibesdk/commit/6da91663a3ae8588e38534c9bb2643812301d1dc))
* implement WebSocket ticket authentication and management system ([1fe8640](https://github.com/harvis-io/vibesdk/commit/1fe8640ddaece52a2befe5a227918831f864c7e0))
* improve GitHub Actions workflow reliability ([1e49bb3](https://github.com/harvis-io/vibesdk/commit/1e49bb365c83b9e2fdebf76d36b9401479121cdc))
* improve phase generation and React render loop prevention prompts ([edc9deb](https://github.com/harvis-io/vibesdk/commit/edc9deb1e4d243dfb80118ddebcad0b6a50c8c16))
* improve SDK error handling and resource cleanup ([17f1d4e](https://github.com/harvis-io/vibesdk/commit/17f1d4ed28487cd83da8ba3271c07ef65f30782b))
* improve workflow metadata handling and cryptographic security ([5869e41](https://github.com/harvis-io/vibesdk/commit/5869e4123aeffe756b0e2b86597b83b4eade5ec3))
* improve workflow reliability and add nightly branch support ([07d2d09](https://github.com/harvis-io/vibesdk/commit/07d2d09d1b65a5673e429f911ec6f770e4d4760d))
* increase temperature and reasoning effort for blueprint ([f0ec7c9](https://github.com/harvis-io/vibesdk/commit/f0ec7c97c519c3c9c06fc54ca827324a90cc960a))
* integration tests with worker ([f565aff](https://github.com/harvis-io/vibesdk/commit/f565aff144bd0c2b6065db9406da269e0d587c9d))
* integration tests with worker ([a68d9cb](https://github.com/harvis-io/vibesdk/commit/a68d9cbde5ba14cba53414361bcbefdb41851f9f))
* introduce @cloudflare/kumo, theme toggle and ui fixes ([942832c](https://github.com/harvis-io/vibesdk/commit/942832cef0e2c1571b3719a2c280e73da253644a))
* introduce @tanstack/query and use it in sidebar apps list fetches ([16142fc](https://github.com/harvis-io/vibesdk/commit/16142fc5ad0df94f5cccbf4f5c1dc9a5b85ab0d9))
* introduce kumo, other ui fixes ([35114e8](https://github.com/harvis-io/vibesdk/commit/35114e825615e60bd576f64f5e80d9622db5868b))
* latest packages updated ([e5496e0](https://github.com/harvis-io/vibesdk/commit/e5496e0cfd2923acc25d7e4f2265b4a0d7fd69f8))
* Login with Cloudflare + Security Fixes ([a72acdd](https://github.com/harvis-io/vibesdk/commit/a72acdd64b66c3ad9ad8cde2c9d83ddf289d4ab6))
* manage feature toggles outside Wrangler vars ([0bfd169](https://github.com/harvis-io/vibesdk/commit/0bfd16911c120e7ea3f9c5eca39adea81d89a323))
* more ui updates, fixes ([74b28cd](https://github.com/harvis-io/vibesdk/commit/74b28cd7adec7521b7f13a60626c581400a3af8e))
* new zero knowledge vault implementation ([fd28396](https://github.com/harvis-io/vibesdk/commit/fd283966ef257178b4332a1c828638d1c3d77f47))
* optimize phase context and reduce max phases to 10 ([0557bf7](https://github.com/harvis-io/vibesdk/commit/0557bf71c61ba6c7eb68ad07600ef87768366cbb))
* optimize pre-commit hook with selective typecheck and related tests ([1cab335](https://github.com/harvis-io/vibesdk/commit/1cab3357291c91f631705a975d4786a5304ed58f))
* persist tanstack query in IndexedDB ([dae555d](https://github.com/harvis-io/vibesdk/commit/dae555de1d26259a5f4612574fe05cd92e83e598))
* persist tanstack query in IndexedDB ([a904751](https://github.com/harvis-io/vibesdk/commit/a9047515abbda0c4ad046f1566789e3d11bed6d8))
* phase implementation propmt rewrite - v78 prompt variant ([ffa547e](https://github.com/harvis-io/vibesdk/commit/ffa547e3e6fedc07c694052a2added4a810424b9))
* presentation specific prompts + prompts restructuring ([b6abaca](https://github.com/harvis-io/vibesdk/commit/b6abaca2cffca283c4e0974905c3a1165542400f))
* prompt tuning for shorter blueprints ([e9041f1](https://github.com/harvis-io/vibesdk/commit/e9041f1793bced58754a177c8a95e2609a5b56de))
* **react:** let consumers replace loading, empty, and error markup ([7dec701](https://github.com/harvis-io/vibesdk/commit/7dec70119c8e23d41b2ae08d383a5be689c59f07))
* readme update ([33f72ab](https://github.com/harvis-io/vibesdk/commit/33f72ab3dea70c1bc2c13e9ce30f79caa1c99422))
* reduce limits ([9f810e7](https://github.com/harvis-io/vibesdk/commit/9f810e7dbc90039a0fa639bc676e1197066bef51))
* reduce limits ([8299ba5](https://github.com/harvis-io/vibesdk/commit/8299ba554b6eee4920c0c7f5adaf0e677ebcaf3c))
* reduce side of blueprint infer for minimal templates ([3eb0039](https://github.com/harvis-io/vibesdk/commit/3eb0039e57bd398afd7b3ea0616f0a532e292a61))
* refactor client methods to include app management functionalities ([b9f0416](https://github.com/harvis-io/vibesdk/commit/b9f041655ae82898e757a19be06e9b35f58f98a8))
* refactor file manager to separate state recording from git operations ([e3d0862](https://github.com/harvis-io/vibesdk/commit/e3d0862d5daf8cb2a1d1ae3e9e9bff4ee2989abf))
* refine agent model configurations and phase generation strategy ([69c8642](https://github.com/harvis-io/vibesdk/commit/69c86425590c108d7926a7c074ee2a830d5aa593))
* remove redundant message and fix file saving in code generation ([6f170e1](https://github.com/harvis-io/vibesdk/commit/6f170e1650f60eb1139272352e0ebe34fa31845d))
* replace CLI token authentication with SDK API key management ([30ba991](https://github.com/harvis-io/vibesdk/commit/30ba9918fc0eb176c65ff0ff0d4912a425413ecb))
* replace template manager with ai template selector ([ca8e7e4](https://github.com/harvis-io/vibesdk/commit/ca8e7e41b7bff0ad64f129138c8c446145597416))
* rewrite presentation preview system ([09653ba](https://github.com/harvis-io/vibesdk/commit/09653ba4e1e5a9a355e88c0c467dceb37fe9f7e8))
* rewrite process monitoring and error handling ([b0db701](https://github.com/harvis-io/vibesdk/commit/b0db701e82fad2d00820b7bd127b412017301cce))
* route owned apps to editor and prefer Think live preview ([6678715](https://github.com/harvis-io/vibesdk/commit/6678715b43d13c6bdd730a1e0f8a8aea5a907538))
* route owned apps to editor and prefer Think live preview ([1a6ad37](https://github.com/harvis-io/vibesdk/commit/1a6ad37e74bb86a7a23d46698d9010df0c3db9ac))
* sdk tests ([a841168](https://github.com/harvis-io/vibesdk/commit/a8411685ff7ef3fce82aba34534d6145bb2a09fe))
* sdk ws ticket auth and auto reconnect ([932271f](https://github.com/harvis-io/vibesdk/commit/932271fd33d9a7f122cd193ae8911195d951339c))
* **security:** enforce app visibility at the dispatch layer ([124720e](https://github.com/harvis-io/vibesdk/commit/124720ee09f0339c5e4018acf08dc83235121219))
* **security:** rate-limit space previews and cache the asset manifest ([b92ecae](https://github.com/harvis-io/vibesdk/commit/b92ecaefdeaab877408ad10c8b9de4de61907904))
* **security:** revoke space-preview tokens on visibility change ([d74e17a](https://github.com/harvis-io/vibesdk/commit/d74e17a17602a048e362d6dcdd062aadb04d825c))
* set up LinkProvider and use it in homepage view all btn ([1c65db8](https://github.com/harvis-io/vibesdk/commit/1c65db8ad0f67f2515de04e7b7d0eff2143478c9))
* **settings:** add connected accounts UI for multi-provider linking ([d446c19](https://github.com/harvis-io/vibesdk/commit/d446c19997a5199b8eec9d8c19d364b26ef2abd6))
* short project titles with live refresh + Think set_title tool ([d3b04f1](https://github.com/harvis-io/vibesdk/commit/d3b04f1cc6d90c76bfc64cbc0965a908c4aac757))
* some prompt improvements ([e136129](https://github.com/harvis-io/vibesdk/commit/e1361297a704e78e059bddcffeb5c3f3f3490782))
* some prompt improvements in agentic project builder ([7faf0e0](https://github.com/harvis-io/vibesdk/commit/7faf0e03cb1f8b7632d8a2f5ec92afc1cbc62d78))
* **space:** back SpaceDO filesystem with Cloudflare Artifacts ([419d37d](https://github.com/harvis-io/vibesdk/commit/419d37d97d5a4c6b0f9069e17aca7527ef7abbe6))
* **space:** gate Cloudflare Artifacts behind a per-app filesystem backend ([e341e04](https://github.com/harvis-io/vibesdk/commit/e341e04deee1f3daabbcacecb9e4e1b95d460d9d))
* **space:** require ARTIFACTS binding and fix think editor file sync ([645bb5b](https://github.com/harvis-io/vibesdk/commit/645bb5bdfdb72f900dc80344235d6a4a9f420198))
* static analysis for browser rendered preview projects ([22be3f8](https://github.com/harvis-io/vibesdk/commit/22be3f8e74b1897254031dbffa0411893d7a5446))
* static analysis for browser rendered preview projects ([320fc84](https://github.com/harvis-io/vibesdk/commit/320fc84454073e2a720deb6dca6deffa8e9060a3))
* suppress AI Gateway token in CI and limit template deploy environment variables ([ee7a83f](https://github.com/harvis-io/vibesdk/commit/ee7a83ff1d1e11bbbf7607c4c7a74a75dbef29d1))
* think-based agent + code space ([16670af](https://github.com/harvis-io/vibesdk/commit/16670affa66cae38520e47322399d06ee08d7fcc))
* **think:** isolate model and trim context ([37b1cd7](https://github.com/harvis-io/vibesdk/commit/37b1cd72f86a6b83d0116de88e382ac1a27c3c05))
* **think:** isolate model and trim context ([1abd92a](https://github.com/harvis-io/vibesdk/commit/1abd92ad919e9d3ed7127f734df2e9a6e12cae64))
* truncate exec command output to prevent token overflow ([2d05283](https://github.com/harvis-io/vibesdk/commit/2d0528363c98fc54c4e105e750eda20b8e55b414))
* **ui:** redesign profile page and add orange gradient button ([ef4d30a](https://github.com/harvis-io/vibesdk/commit/ef4d30a50952e76adaa3287b9218cc74307171bb))
* **ui:** refresh app shell with Kumo ([741178d](https://github.com/harvis-io/vibesdk/commit/741178dabffb49d621508c26994f13c3ef039825))
* **ui:** refresh app shell with Kumo ([7431cf7](https://github.com/harvis-io/vibesdk/commit/7431cf774b5bf0daea4b425f713da3322f6c6d91))
* update model configurations and enhance inference handling ([f7960d5](https://github.com/harvis-io/vibesdk/commit/f7960d5b4e5c71297733bd6e3f653253efa14ce8))
* upgraded to sandbox sdk version 0.5.2 ([9f9cc7a](https://github.com/harvis-io/vibesdk/commit/9f9cc7aa98be1373db0267b39cb7dd67d82d5dd6))
* use agentic builder directly for handling user messages ([681bbbe](https://github.com/harvis-io/vibesdk/commit/681bbbeb7ace71a8cdebb7fc62ed35b99370cb61))
* use original worker types in sdk ([6745f04](https://github.com/harvis-io/vibesdk/commit/6745f0446bb11c6fd99adaddd9c45400a1f33014))
* use original worker types in sdk ([0bc7db9](https://github.com/harvis-io/vibesdk/commit/0bc7db9bf354b6160da046cb0a765a1e502f14e5))
* wrap global fetch to preserve context in Workers runtime ([b7be5db](https://github.com/harvis-io/vibesdk/commit/b7be5dba23ec03315eb52cc83784699553f56868))


### Bug Fixes

* add cf limits gate ([da3386e](https://github.com/harvis-io/vibesdk/commit/da3386e2e54f11dd54392cc49f4bdac7b2a61ef0))
* add cloudflare beacon url to csp ([90561ad](https://github.com/harvis-io/vibesdk/commit/90561ad4df525a54d478a3761bd8bbb8ea2c12c1))
* add logs and ownership check for github export ([271b339](https://github.com/harvis-io/vibesdk/commit/271b3393dd1383a24830c11dc086d5cf59066203))
* add missing lock changes ([b567804](https://github.com/harvis-io/vibesdk/commit/b5678042b61af353a1777695baaaf68f60134ac7))
* add noopener,noreferrer to _blank targets to prevent reverse tab… ([16d7119](https://github.com/harvis-io/vibesdk/commit/16d7119d124f787aede8b50a7d5d147523a4d5d6))
* add noopener,noreferrer to _blank targets to prevent reverse tabnabbing ([70441b8](https://github.com/harvis-io/vibesdk/commit/70441b8b2f64ecc75e9a437d52fef045736bb11a))
* add optional chaining to prevent runtime errors in blueprint rendering ([2a2d86c](https://github.com/harvis-io/vibesdk/commit/2a2d86c6d2afe45b4445e70d617e39d3367fd90d))
* **agents:** prevent RCE via bootstrap command whitelist bypass ([ae792a2](https://github.com/harvis-io/vibesdk/commit/ae792a2bb48282714c47464c15ca67942f2eab31))
* **agents:** prevent RCE via bootstrap command whitelist bypass ([5dca3ab](https://github.com/harvis-io/vibesdk/commit/5dca3ab4bec4496c645e7663326705a9df1ec661))
* ai gateway config issue ([01de759](https://github.com/harvis-io/vibesdk/commit/01de759cedaf09f5beb88a80fd8cdfb9dfb7fcfe))
* alias vendored artifacts-viewer for the Worker deploy build ([2509dfa](https://github.com/harvis-io/vibesdk/commit/2509dfad0d943efa67847b348e59fc384fa423d1))
* allow editing package.json in scratch templates ([ee69533](https://github.com/harvis-io/vibesdk/commit/ee6953386fed3490ddcdc407c4bb26ce248d2506))
* allow labeling fork pull requests ([1a83c48](https://github.com/harvis-io/vibesdk/commit/1a83c480474f3fde30518357c15ff41f66b33051))
* app and chat layouts ([c0c39af](https://github.com/harvis-io/vibesdk/commit/c0c39af2c2a73facec3771b635aa3c057bacc0f3))
* **apps:** harden public app endpoints against disclosure, DoS, view tampering ([1023f68](https://github.com/harvis-io/vibesdk/commit/1023f68ab816f04ea55e81f299b8300a9426b647))
* **apps:** harden public app endpoints against disclosure, DoS, view tampering ([3600f72](https://github.com/harvis-io/vibesdk/commit/3600f7234202a1c15f53e0c657cce7fa155c1de3))
* ask_questions tool call wording ([ce86f8d](https://github.com/harvis-io/vibesdk/commit/ce86f8dbd28e03c4a375bfb9a45e1ce4d6fdaff6))
* **auth:** close OAuth account-takeover via email-based identity binding ([2303dcf](https://github.com/harvis-io/vibesdk/commit/2303dcfe6f6d6c93e299dbc5e6d3d49ce8d6d53b))
* **auth:** enforce ALLOWED_EMAIL allowlist on OAuth callback ([a39e4e4](https://github.com/harvis-io/vibesdk/commit/a39e4e42b69765856b873672c3adbfe2bf499f70))
* **auth:** harden session/API-key revocation and secret generation ([54fc4e0](https://github.com/harvis-io/vibesdk/commit/54fc4e0bd2803666e7a4e6096632dd9785687329))
* **auth:** harden session/API-key revocation and secret generation ([7c4e0bf](https://github.com/harvis-io/vibesdk/commit/7c4e0bf8d13fac11687d656f6b2fb4633d53735d))
* bonk model name ([57d83c0](https://github.com/harvis-io/vibesdk/commit/57d83c0ce4750adb38958901b27cf896afa99da5))
* bring back some radix deps ([57472fb](https://github.com/harvis-io/vibesdk/commit/57472fbab47bc6f656d6b2065869e023208a4055))
* bug where preview url did not use tunnel url ([61291d0](https://github.com/harvis-io/vibesdk/commit/61291d0cb3843e398b19ab10ff682efbc1115210))
* bug where preview url did not use tunnel url when getting instance state ([d2abffe](https://github.com/harvis-io/vibesdk/commit/d2abffed7c74e06fe7dead693f80a5c7e9684a8a))
* cf oauth client ci ([3842b66](https://github.com/harvis-io/vibesdk/commit/3842b66e573c246079e73123886094ab59dfa6e7))
* **chat:** full-width tool trace + slide-style clarifying questions ([3016918](https://github.com/harvis-io/vibesdk/commit/30169188717e6823e92cacc10f353015c2fde52f))
* **ci:** use canonical gemini-3-pro-preview slug ([9d22900](https://github.com/harvis-io/vibesdk/commit/9d22900628be6efa632bd322ed13529ef140cf45))
* **ci:** use canonical gemini-3-pro-preview slug ([63e78b1](https://github.com/harvis-io/vibesdk/commit/63e78b1476787b088158d2cd02a9662d859d6785))
* **ci:** use gemini in bonk ai-pr-review workflow and fix vuln ([17f56d6](https://github.com/harvis-io/vibesdk/commit/17f56d61f5addfc9b2aa95b608e35033e671e88d))
* **ci:** use gemini in bonk ai-pr-review workflow and fix vuln ([277dbad](https://github.com/harvis-io/vibesdk/commit/277dbad88e3cc40570d41c260e7f1f9a2e5f61b0))
* cleanup chat.tsx for build ([d80c416](https://github.com/harvis-io/vibesdk/commit/d80c41625684f501e59d600593572c3832251638))
* cleanup settings up and ui refresh ([612c8be](https://github.com/harvis-io/vibesdk/commit/612c8be678737df983d2773fc6c6d185a1863ae9))
* clear local state when signing out ([7d21236](https://github.com/harvis-io/vibesdk/commit/7d212364afd93c831249f66c2e900903b59fbe25))
* compact prompt box spacing and remove blueprint placeholder ([1ee7285](https://github.com/harvis-io/vibesdk/commit/1ee72851aa8beee236e12d652189e9dd002a76f2))
* convo id uniqueness and improve message deduplication ([d4ae61d](https://github.com/harvis-io/vibesdk/commit/d4ae61d6357d1c107b2ed5148ea5cbb18bfd6248))
* correct indentation in vault-context unlock error handler ([f908d31](https://github.com/harvis-io/vibesdk/commit/f908d31e0e3956675a9def25e74d1913dbb19b9c))
* create new orange gradient button and use it ([af0b220](https://github.com/harvis-io/vibesdk/commit/af0b2203674da12f7328a2168e1e370dd0ad3f35))
* create query client in app level, not at module scope ([7f9410f](https://github.com/harvis-io/vibesdk/commit/7f9410f4aac9fa1540b08aa7cac2821cd6a6f47f))
* Critical OAuth State Manipulation Vulnerability in GitHub Export ([340c332](https://github.com/harvis-io/vibesdk/commit/340c332c62b88a7d0f321d888e2ee1edd318190d))
* design tokens cleanup and design updates ([9de4b25](https://github.com/harvis-io/vibesdk/commit/9de4b256a32ef399a4172d3a519990faf85e5c12))
* detect module-level JSX anti-pattern in safety gate ([37e5ef5](https://github.com/harvis-io/vibesdk/commit/37e5ef5edd6c48b075d8cd31b03b40b502a43d2b))
* discover page input components use kumo ([f3f90b6](https://github.com/harvis-io/vibesdk/commit/f3f90b6a8d952896ae7f56236074f8e4fae047e9))
* do not allow non owner to export code to github repo after oauth callback ([0b30b38](https://github.com/harvis-io/vibesdk/commit/0b30b38eb51f5b77f1c56aeef3b546d586ab6eba))
* do not log the entire conversation history ([102cbfa](https://github.com/harvis-io/vibesdk/commit/102cbfa7a7f47501677bfa8efe843b6fb4bc5378))
* do not log the entire conversation history ([4785fa7](https://github.com/harvis-io/vibesdk/commit/4785fa7ee9a62fb46d353bfa8a3c120efbff5f1c))
* ensure workspace directory exists before writing files ([17258f3](https://github.com/harvis-io/vibesdk/commit/17258f3094e405360e1461dd04d8ae5b1af4cebd))
* exclude auth/account queries from persisted query cache ([ed011f2](https://github.com/harvis-io/vibesdk/commit/ed011f22d5b3e5bd689ec8637c59c964a0779ce6))
* expose artifacts setting as a worker variable ([a651a52](https://github.com/harvis-io/vibesdk/commit/a651a5277e07c40eb78b000e48f69345426b9849))
* expose artifacts setting as a worker variable ([1f2c099](https://github.com/harvis-io/vibesdk/commit/1f2c099b56805cc56270aa82e2833dedc4bfc0ed))
* files format ([da31e76](https://github.com/harvis-io/vibesdk/commit/da31e761e6cba4e839f5f0c527410128f5b18fd7))
* filter protected files ([ff3a302](https://github.com/harvis-io/vibesdk/commit/ff3a302bf8fa3059156c4f10efc30c55aa6f0455))
* fix general agent app creation ([fa080ec](https://github.com/harvis-io/vibesdk/commit/fa080ec378a6756584596da800b0944fd83b9099))
* fixed github bot's commit mistakes ([a729366](https://github.com/harvis-io/vibesdk/commit/a72936654aa13113e4a73d8902bded052566f0cd))
* gate artifacts binding on ENABLE_ARTIFACTS during deploy ([98e619d](https://github.com/harvis-io/vibesdk/commit/98e619d396df978d8003e63d90804205eb8ebd57))
* gate artifacts binding on ENABLE_ARTIFACTS during deploy ([8191265](https://github.com/harvis-io/vibesdk/commit/8191265071bebd0c55fa9182e0b4cdf16e5dea1c))
* general design updates in homepage, auth-button ([15fd104](https://github.com/harvis-io/vibesdk/commit/15fd1045c87847ae32ac947e51df023dea016f4f))
* harden AI Gateway proxy against unbounded requests (CWE-770) ([f8077b3](https://github.com/harvis-io/vibesdk/commit/f8077b368ce2326a983f3a9fcb285bbfd4f256f5))
* harden AI Gateway proxy against unbounded requests (CWE-770) ([12b7059](https://github.com/harvis-io/vibesdk/commit/12b705909eca88570dc58dc75f7dfacc2e1b8fac))
* homepage, settings page design updates and fixes ([8fd50b6](https://github.com/harvis-io/vibesdk/commit/8fd50b6a64cb9f0efe7e7d5e28ff34416091f599))
* icons in settings gateway dropdown ([fb6ce57](https://github.com/harvis-io/vibesdk/commit/fb6ce574067a870cb5f5bd29969180b725ea58ae))
* ignore useEffect deps lint error ([72a8a86](https://github.com/harvis-io/vibesdk/commit/72a8a864b49f86bae604a6333a7b5e543689fefd))
* improve browser rendering checking logic ([fa397bb](https://github.com/harvis-io/vibesdk/commit/fa397bb0b44aab332139ce99791bf5816dcec3c7))
* improve cross-method sign-in for shared emails ([ec29a67](https://github.com/harvis-io/vibesdk/commit/ec29a6738ea750eb3ec893f35196c921a2fe2140))
* improve font loading ([7d82ca0](https://github.com/harvis-io/vibesdk/commit/7d82ca0b7091ff42283de2cc996ff6cc5c160950))
* improve shell safety and variable handling in claude-reviews gating ([f656cf0](https://github.com/harvis-io/vibesdk/commit/f656cf07d0e1b9d33ea593733ca15b77a715452d))
* improve shell safety and variable handling in claude-reviews gating ([31a1820](https://github.com/harvis-io/vibesdk/commit/31a1820c2c3cac6ce7d41401a13565ec2f91f08a))
* improve ui, search behavior ([46f1b2d](https://github.com/harvis-io/vibesdk/commit/46f1b2d0cab646055c413a95cba37cccf75f38f2))
* improved process monitoring, failure detection and restarts ([ca7d309](https://github.com/harvis-io/vibesdk/commit/ca7d309405c4a750f344371caef6a7b95b0714d3))
* increase max-width for chat box when main area not visible ([0e14a7a](https://github.com/harvis-io/vibesdk/commit/0e14a7ab8db6d91298e7b3611ec4e3340f9b3027))
* increase z-index on hero text on homepage ([7c0a922](https://github.com/harvis-io/vibesdk/commit/7c0a92215d7cddedd8741f7d4c5a2cb4e01c1087))
* jwt oauth state for github oauth to prevent manipulation ([e3a25a8](https://github.com/harvis-io/vibesdk/commit/e3a25a80056f413e3163452702f57cec701e90a4))
* **layout:** use global header with sidebar toggle and sign-in button ([3bfa0fd](https://github.com/harvis-io/vibesdk/commit/3bfa0fd71034ac3f6cc5fb53e77ef6418912eb7b))
* make database table responsive instead of stretching parent ([62165df](https://github.com/harvis-io/vibesdk/commit/62165df96a323611a3f4532cd409a0ecc87faee8))
* make database table responsive instead of stretching parent ([ad363d7](https://github.com/harvis-io/vibesdk/commit/ad363d7c83fbbfc5dd76f5107921b9c752cda47a))
* make email allowlist test self-contained ([f5fdec4](https://github.com/harvis-io/vibesdk/commit/f5fdec4fcc2b0ba8cccb740e6af4e279d6af6700))
* make globe also gradient filled ([538565a](https://github.com/harvis-io/vibesdk/commit/538565a4b614fa1d5b75cb6393d60a24d7ff0d6d))
* make remote database migrations required during deploy ([a318f08](https://github.com/harvis-io/vibesdk/commit/a318f08625dbb443af7f70dd08d295fd49a0b96b))
* make remote database migrations required during deploy ([af33ab2](https://github.com/harvis-io/vibesdk/commit/af33ab217c0983ca04cd6210875f6eef338a707d))
* manual template selection ([e440372](https://github.com/harvis-io/vibesdk/commit/e440372760d69e6f587bfcb94d93c7bece39a6b6))
* max-width on title, move buttons around ([5ed143d](https://github.com/harvis-io/vibesdk/commit/5ed143da53e1ce7efdb594349302123883686de7))
* monaco perf and file tree ui ([25d7dfe](https://github.com/harvis-io/vibesdk/commit/25d7dfe70cb09615acb60c01a6aa9a69c2fc30c9))
* more visibility for containers and workers ([a632039](https://github.com/harvis-io/vibesdk/commit/a632039d2b65a48a2448a5f99744b2f971c66174))
* mutations are scoped to appIds ([8e91f38](https://github.com/harvis-io/vibesdk/commit/8e91f38011522f58323c14d880f68c227db41462))
* new build button colors ([ecfdac6](https://github.com/harvis-io/vibesdk/commit/ecfdac6d9b0a5efaf31dfdb4fb22bc9f5a36d5ed))
* OAuth and login fixes ([434c5b3](https://github.com/harvis-io/vibesdk/commit/434c5b3e110409f7b561c529e38db0a2bdc3ebf4))
* only app owner should be able to deploy preview ([ba22bf8](https://github.com/harvis-io/vibesdk/commit/ba22bf85cdee42c6144ccdfe071b32be36b3e24e))
* opencode version issue ([7842ab9](https://github.com/harvis-io/vibesdk/commit/7842ab91fb259753083f37e4571ed6c3b3f8d8fd))
* page load improvements ([3ae3d92](https://github.com/harvis-io/vibesdk/commit/3ae3d92658144ebce08637b2d52ae95df0f5bb01))
* pass manually selected template and skip ai flow ([ad7ae4e](https://github.com/harvis-io/vibesdk/commit/ad7ae4ec992ec85e17d073a15d63b28ba2462671))
* prevent duplicate agent session creation and improve error handling in chat initialization ([40103ef](https://github.com/harvis-io/vibesdk/commit/40103ef67687d642b955172f6a841dd3abf6125d))
* prevent platform API key leak via user-supplied AI gateway baseUrl ([854676e](https://github.com/harvis-io/vibesdk/commit/854676ebf99642a7afa4055fd982815edc5508c8))
* prevent platform API key leak via user-supplied AI gateway baseUrl ([d8a2526](https://github.com/harvis-io/vibesdk/commit/d8a2526e73f8e46e6c83271ce5e46730cb41f192))
* preview update fixes + navigation ([5b96591](https://github.com/harvis-io/vibesdk/commit/5b96591e074f4fcc7fe15ad14236abf107fd8910))
* **preview:** add CORS headers to space preview responses ([d4ab976](https://github.com/harvis-io/vibesdk/commit/d4ab976f97c3424fd5b3aa3175abfe7937e9e381))
* **preview:** token+cookie auth for space previews and Safari banner ([402ab7c](https://github.com/harvis-io/vibesdk/commit/402ab7ca2b2365774027666250eadf95fead3139))
* **preview:** token+cookie auth for space previews and Safari banner ([cf88d69](https://github.com/harvis-io/vibesdk/commit/cf88d691c5451b8e191c898154ae4758e13058d8))
* **publish:** install pnpm via action-setup for pack ([e853fe0](https://github.com/harvis-io/vibesdk/commit/e853fe0c72746c09b0e45b3d24e6713ee354de4a))
* **publish:** pack with pnpm so catalog ranges resolve ([4cc22c2](https://github.com/harvis-io/vibesdk/commit/4cc22c25f27e5b2a5fcacc90efe452fef3dad57c))
* race condition between instance start and static analysis ([befdde7](https://github.com/harvis-io/vibesdk/commit/befdde72fb8d6defd61184dbe47d8054232ce616))
* redesign profile page and fix routes and link it ([a00703a](https://github.com/harvis-io/vibesdk/commit/a00703a3aa1b771c2b2a0a320fa2b99e2d0dee97))
* reduce chat max-width when main view is visible ([ac890c1](https://github.com/harvis-io/vibesdk/commit/ac890c1a3f68c85629e9c53fa9cd4363bb92470b))
* refine preview switching logic and fix code generation prompt ([a658282](https://github.com/harvis-io/vibesdk/commit/a658282b1ca6e364e5dbe374ca75fde12d18ab99))
* refresh Cloudflare AI Gateway list without reconnecting ([074924d](https://github.com/harvis-io/vibesdk/commit/074924db6ae82ad3ee9bc7108c504afc8c072481)), closes [#398](https://github.com/harvis-io/vibesdk/issues/398)
* refresh Cloudflare AI Gateway list without reconnecting ([#398](https://github.com/harvis-io/vibesdk/issues/398)) ([04811ed](https://github.com/harvis-io/vibesdk/commit/04811ed39852b0b6f6822cf85cb88fb81aba2d70))
* reload chat session when switching apps in the sidebar ([076f3d1](https://github.com/harvis-io/vibesdk/commit/076f3d1cbdf44ee59ed385b931a0645853fac2c8))
* remove and ignore tsbuildinfo file ([2cf7ff5](https://github.com/harvis-io/vibesdk/commit/2cf7ff552902bb50b0d32c836eb0fd82b1e90d82))
* remove app creation initialization bottleneck ([1ac531f](https://github.com/harvis-io/vibesdk/commit/1ac531fe7ecb1c4f4bd70691a58f6deb76418df9))
* remove explicit header background ([71cacf9](https://github.com/harvis-io/vibesdk/commit/71cacf9b61ce1301ff52c15a6258ebd21c2b4233))
* remove opencode ref ([e358598](https://github.com/harvis-io/vibesdk/commit/e3585982d3eb5bdc4381dbcc586990435834bcc1))
* remove redundant width/height styles from preview iframe ([f1efe5b](https://github.com/harvis-io/vibesdk/commit/f1efe5b1905cc59c6ee596183808add37f7a0e00))
* remove unused google fonts ([96dd6cc](https://github.com/harvis-io/vibesdk/commit/96dd6ccb51ab28f522ac1e3ba1d0346b399dba40))
* remove vault provider and its code in frontend ([981286f](https://github.com/harvis-io/vibesdk/commit/981286ff4bc9e39c8e28b08f80067e53178d36ef))
* resolve babel traverse import compatibility and disable phase parameter in safety gate ([c33a972](https://github.com/harvis-io/vibesdk/commit/c33a972a4aec6bee0ce056192a0bc75300db5d51))
* resolve require("buffer") deploy error 10021 in Workers bundle ([f14b40c](https://github.com/harvis-io/vibesdk/commit/f14b40c26c9d1d183517d06519e325ff3c22c5a6))
* search and deploy for preview screen ([30ce835](https://github.com/harvis-io/vibesdk/commit/30ce835ac7f4b9389840543a689517b443778452))
* secure immediate Cloudflare connection ([69cb053](https://github.com/harvis-io/vibesdk/commit/69cb053ca89b30976531c3a49addad1bd83b118a))
* **security:** block prompt-injection data exfiltration via chat ([f6c475f](https://github.com/harvis-io/vibesdk/commit/f6c475f26ab36fcb498f5864589b6fcf221db718))
* **security:** block prompt-injection data exfiltration via chat ([b6ab895](https://github.com/harvis-io/vibesdk/commit/b6ab895e36e88885aec656cbb641c1f587d61bc2))
* **security:** harden bootstrap command validation against postinstall RCE ([31bfc6f](https://github.com/harvis-io/vibesdk/commit/31bfc6fc5ca4721f8bd4079d2ef2146c4959d362))
* **security:** key anonymous rate limit on IP, remove dead email-OTP … ([b20cf32](https://github.com/harvis-io/vibesdk/commit/b20cf32ab351f34c9ef2a6768223d82041f635d9))
* **security:** key anonymous rate limit on IP, remove dead email-OTP flow ([0548ff3](https://github.com/harvis-io/vibesdk/commit/0548ff30d11ed43e5b59001f144ecd056da50e89))
* **security:** strip browser credentials at sandbox proxy and redact git logs ([b3db5dc](https://github.com/harvis-io/vibesdk/commit/b3db5dcfa794313042f5967fce4e15892bf8d0ad))
* **security:** verify per-port token before sandbox preview access ([34e3bb4](https://github.com/harvis-io/vibesdk/commit/34e3bb4ca5e926aaf0c2c2dabdf5435d23741d19))
* set a max-width on app and chat page titles ([efbd8d7](https://github.com/harvis-io/vibesdk/commit/efbd8d728363c26301db46aa12685980daf22fd3))
* set mobile breakpoint to 0 temporarily ([d589a95](https://github.com/harvis-io/vibesdk/commit/d589a95ea8db5a60bff5335c72c4a2a346e14ed6))
* settings page bg not filling full height ([be7dc8a](https://github.com/harvis-io/vibesdk/commit/be7dc8a382c7d3a6593a243e0734079b59ce336f))
* settings ui use kumo ([5964a64](https://github.com/harvis-io/vibesdk/commit/5964a645a0a1d267a64cb40d6765162e30712fae))
* show 24 recent public apps on homepage ([80ee28c](https://github.com/harvis-io/vibesdk/commit/80ee28cdbb0eda50024ceb1575d47e49b721adc2))
* show password validation error ([4c86278](https://github.com/harvis-io/vibesdk/commit/4c862784f5bba62716cc6ec6926e14ec742c6a23))
* show running tool call at end separately ([f5251d3](https://github.com/harvis-io/vibesdk/commit/f5251d3ced9f8ec6d46166845f1940496e76fc43))
* sidebar and app, chat route ui fixes ([72810a5](https://github.com/harvis-io/vibesdk/commit/72810a5c7593eafb8efd011af30f4cd8c6f4db57))
* sidebar component usage and improvements ([e33519c](https://github.com/harvis-io/vibesdk/commit/e33519c7e5aa548e476c0478a6104a011e19cf31))
* sidebar menu icons collapsed ui ([9de97df](https://github.com/harvis-io/vibesdk/commit/9de97dfa7f39966dbdf9ea4db977966b181dd8e2))
* **sidebar:** sidebar, app header and chat route ui fixes ([aee3d18](https://github.com/harvis-io/vibesdk/commit/aee3d18703eed1e77057cdf0a764bf66785e6aab))
* **space:** checkpoint flush reads overlay, replay checkpoint in state fast-path ([15ebbec](https://github.com/harvis-io/vibesdk/commit/15ebbec16f255173500665d4da584721bc93162c))
* **space:** durable workspace files and git history across DO resets ([ff8f53c](https://github.com/harvis-io/vibesdk/commit/ff8f53ce4d1d0f29c045a96260221c540f63b6af))
* **space:** stabilize artifacts sync and preview deploys ([f7e3123](https://github.com/harvis-io/vibesdk/commit/f7e31238a06f3f9e21a30980809c50a617afeaba))
* **space:** strip Service-Worker-Allowed from preview responses ([918e974](https://github.com/harvis-io/vibesdk/commit/918e97480ee44e357abe99bf33c27259d6ac7ebd))
* **space:** strip Service-Worker-Allowed from preview responses ([22f1900](https://github.com/harvis-io/vibesdk/commit/22f19000b5e06023001ba9741cc173f14e5f0530))
* stabilize legacy chats and preview rendering ([61421ed](https://github.com/harvis-io/vibesdk/commit/61421ed3575209356dc19828c7453b67a2d8d41f))
* streamline deploy button configuration ([61bc5f7](https://github.com/harvis-io/vibesdk/commit/61bc5f78d1eaa87f917e76d8c9cf3bb6b5f4f3b1))
* styling housekeeping, minor UI improvements ([5821919](https://github.com/harvis-io/vibesdk/commit/5821919bb5cb92603938cf1ac35f581da95dfc85))
* styling housekeeping, minor UI improvements ([c5cd2f1](https://github.com/harvis-io/vibesdk/commit/c5cd2f185db45d9a2c5b807f19df31a3107bed2c))
* support markdown in monaco ([11c19ed](https://github.com/harvis-io/vibesdk/commit/11c19ed9c0e0bfad249f3254c8d2ffcb01b277de))
* support markdown in monaco editor ([6716b94](https://github.com/harvis-io/vibesdk/commit/6716b94611c8969acb01899512a05f0b437e08f2))
* template cache clear before import + init meta in behavior constructor ([c6a329e](https://github.com/harvis-io/vibesdk/commit/c6a329e13b34e02da3ff3631b40738154a5de2da))
* template import and state init ([9f5f787](https://github.com/harvis-io/vibesdk/commit/9f5f787a8c1a40e04e02c220ab3c900eb44b3ca6))
* template initialization ([7db6ca2](https://github.com/harvis-io/vibesdk/commit/7db6ca2a7d8f9f6e418e38379a5e25f0caaf5c0d))
* **think:** align deploy action styling ([c37a2b1](https://github.com/harvis-io/vibesdk/commit/c37a2b17f92fce38e0c7c250768e855a09a33d14))
* **think:** charge credits for model steps ([e5839d0](https://github.com/harvis-io/vibesdk/commit/e5839d0e362bc1ba33211bf50ba8747c0628a9fb))
* **think:** end max-steps wrap-up on a user turn ([64d6a93](https://github.com/harvis-io/vibesdk/commit/64d6a930ee45a7b24a5ce90c6442bcafff8f06e6))
* truncate long project title in Agent-mode preview header ([#394](https://github.com/harvis-io/vibesdk/issues/394)) ([4051aad](https://github.com/harvis-io/vibesdk/commit/4051aadd31ed26c7688d613f07e6b93ae4ed77ee))
* truncate long project title in preview header ([fb67d6c](https://github.com/harvis-io/vibesdk/commit/fb67d6c5baaac564654a9d8a173cb108f603802c)), closes [#394](https://github.com/harvis-io/vibesdk/issues/394)
* **udiff:** insert diff replacement content literally ([ea1c7be](https://github.com/harvis-io/vibesdk/commit/ea1c7be336521b3537c029650ad7710f18535e75))
* **udiff:** insert diff replacement content literally (avoid $-substitution) ([6fdd77e](https://github.com/harvis-io/vibesdk/commit/6fdd77e9c6a92dd275946c46177ddc36cb70ffb5))
* ui and convo state management ([0323c7a](https://github.com/harvis-io/vibesdk/commit/0323c7a04e20a6abae41ee1ca7483b6360e4698f))
* ui and logging imp for cf oauth ([fd8f281](https://github.com/harvis-io/vibesdk/commit/fd8f2814609b387cd8ad6156b52f1790619ffba9))
* ui and logging imp for cf oauth ([86ebbdb](https://github.com/harvis-io/vibesdk/commit/86ebbdb358bed0ad7a6a90cf2cb1005523623f0d))
* ui auto focus, preview hiding and blueprints ([cfe24e3](https://github.com/harvis-io/vibesdk/commit/cfe24e3e99b418bca97cd4d5bd8d30602a6a7ebe))
* ui issues ([3774ee0](https://github.com/harvis-io/vibesdk/commit/3774ee0220eacbc0f94b687da72425a2964c9810))
* unintended change leading to bad behaviour ([7a586cc](https://github.com/harvis-io/vibesdk/commit/7a586cc41023546cace89df31a84fd00bddc427b))
* update favicon ([42bd828](https://github.com/harvis-io/vibesdk/commit/42bd8283ad0157238111b3974051de957b5de5da))
* update private clone button design ([5d0d908](https://github.com/harvis-io/vibesdk/commit/5d0d90811d83572c11cba0e04a34f0dd098fddf4))
* upgrade framer-motion and monaco-editor to latest ([ca61644](https://github.com/harvis-io/vibesdk/commit/ca616445146851f0b8b80929657e214e41128f6c))
* upgrade kumo ([9f40750](https://github.com/harvis-io/vibesdk/commit/9f40750e7e8556d579ccd2a6630ec74c4157a0dd))
* upgrade vite to v8 which uses rolldown-vite ([c8fb2dd](https://github.com/harvis-io/vibesdk/commit/c8fb2dde92f25988c51a3d0bde65c553c76eff1a))
* use current AI Gateway credit balance endpoint ([7d28ac6](https://github.com/harvis-io/vibesdk/commit/7d28ac69bde550439170fc6212f6dfb77536bdb7))
* use funky-mono font for settings headers ([d5fb118](https://github.com/harvis-io/vibesdk/commit/d5fb11880e0509ad96aac3ea553a9a5fbe6a5d6d))
* use global-header with sidebar-toggle and sign in button ([24eedaa](https://github.com/harvis-io/vibesdk/commit/24eedaab98189b8b5415a2b539de27d821300c37))
* use kumo tabs for visibility filter in apps page ([e9d8c4e](https://github.com/harvis-io/vibesdk/commit/e9d8c4e5524d7f0f69684eaf74d5eb2c3c19f2c9))
* use kumo-subtle instead of text-tertiary ([9d61861](https://github.com/harvis-io/vibesdk/commit/9d61861527833ad3349f5ec6244321911150ab7e))
* use per page titles as per context ([d8e50e7](https://github.com/harvis-io/vibesdk/commit/d8e50e7ca0ad4eeb25dd123162f100b0d2735625))
* use safeFiles instead of finalFiles for phase implementation logging and broadcast ([849fdce](https://github.com/harvis-io/vibesdk/commit/849fdced2ad43dbf79be8d44d74f3524b2bb7f70))
* use sidebar persisted state as default ([ac280a6](https://github.com/harvis-io/vibesdk/commit/ac280a608df3c098c28d7bedec0052a74c5bcfa8))
* use tanstack query for all fetch calls ([3c1bb93](https://github.com/harvis-io/vibesdk/commit/3c1bb935676aa316c7e5b4bfb3c8adfc99877f6f))
* use tanstack query for discover page and homepage ([121b8a7](https://github.com/harvis-io/vibesdk/commit/121b8a7010eb93588b5af85fd585feb1551d28bd))
* use tanstack query for usage limits api calls ([3d737ac](https://github.com/harvis-io/vibesdk/commit/3d737ac5ac48b6e7cf6e1a9a5bdf7dd3bc02b08b))
* variable name mismatch in simple code generation operation ([22b8f00](https://github.com/harvis-io/vibesdk/commit/22b8f0082ab0817be9fd9571c6d0806c49c1180a))
* wire cf oauth encryption key and per-env jwt/oauth secrets in ci ([d0256b0](https://github.com/harvis-io/vibesdk/commit/d0256b0f047cf0514c7274e2e64dd8963525ef29))
* wire up onConnect to coding agent ([318f6e2](https://github.com/harvis-io/vibesdk/commit/318f6e2620654e3c442c5926c84a296bd940d619))
* wrangle rupdate ([9666d98](https://github.com/harvis-io/vibesdk/commit/9666d98518b2292b0aa58e1aee18ac1a95cbb2e9))


### Performance Improvements

* lazy load monaco editor ([61afce2](https://github.com/harvis-io/vibesdk/commit/61afce27afe9a744f26e70dc0575cdd6f659687d))
* prune unchanged subtrees when computing commit diffs ([bd5572c](https://github.com/harvis-io/vibesdk/commit/bd5572c5358a0005ef38da8d86496213e290319a))


### Reverts

* remove USE_AGENT_SDK flag from Claude Code Action workflows ([1380279](https://github.com/harvis-io/vibesdk/commit/13802798cf81fafa756d2d6c5030ea837db2fe00))
